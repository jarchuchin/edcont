...
Public MustInherit Class DBObjectOracle
...
#Region "Constructores"
    Public Sub New()
        sch = ConfigurationManager.AppSettings("OracleSchem")
    End Sub
#End Region
...
#Region "Metodos de clase dbobject"
    Private Sub OpenConnection()
        connection = New OracleClient.OracleConnection(System.Configuration.ConfigurationManager.ConnectionStrings("SkolarConnectionStringOracle").ConnectionString)
        connection.Open()
    End Sub
    ...
    Protected Function ExecuteScalar(ByVal mysql As String, ByVal myParameters() As IDataParameter) As Object
        Me.OpenConnection()
        Dim command As OracleClient.OracleCommand = Me.BuildQueryCommand(mysql, myParameters)
    ...
    Protected Function ExecuteDataSet(ByVal mysql As String, ByVal myparameters() As IDataParameter) As DataSet
        ...
        Dim myda As OracleClient.OracleDataAdapter = New System.Data.OracleClient.OracleDataAdapter(command)
        myda.Fill(ds)
        command.Dispose()
        Me.CloseConnection()
    ...
    Protected Function ExecuteNonQuery(ByVal mysql As String, ByVal myparameters() As IDataParameter, _
     Optional ByVal returnLastID As Boolean = False) As Integer
        ...
        If returnLastID Then
            command = New OracleClient.OracleCommand("SELECT @@IDENTITY as lastId", Me.connection)
    ...
    Private Function BuildQueryCommand(ByVal mysql As String, ByVal myParameters() As IDataParameter) As OracleClient.OracleCommand
        Dim command As OracleClient.OracleCommand = New OracleClient.OracleCommand(mysql, Me.connection)
