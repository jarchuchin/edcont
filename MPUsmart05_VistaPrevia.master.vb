...
Partial Class MPUsmart05_VistaPrevia
    Inherits System.Web.UI.MasterPage

	Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
		Menu1.modoEdicion = True
		Menu1.modoVistaPrevia = True
		llenado()
	...
	Private Sub getCurrentClasificacionenAccordion()
		...
		Dim dView As Data.DataView = New Lego.Clasificacion().IndiceClasificaciones(idRoot, True)
