...
Partial Class Sec_SalonVirtual_Controles_displayEstadisticasSalon
    ...
    Sub colocarDatos()
        ...
        Dim dtx As DataTable = mysvup.GetTablaSeguimiento(salon)
        ...
        lnkDescargar.NavigateUrl = "~/sec/salonVirtual/ExcelDownloadSeguimiento.aspx?idSalonVirtual=" & mysv.id
