...
Partial Class Sec_SalonVirtual_Controles_displayActividades
    ...
    Public Function getUrl(claveClasificacionItem As Integer, claveClasificacion As Integer, claveidProc As Integer, claveProcedencia As String, claveRoot As Integer) As String
        Return "~/sec/salonVirtual/VerActividad.aspx?idRoot=" & claveRoot & "&idClasificacion=" & claveClasificacion & "&idCI=" & claveClasificacionItem & "&idSalonVirtual=" & salon
    End Function
End Class
