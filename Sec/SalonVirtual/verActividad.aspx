...
<%@ Register src="Controles/DisplayEstadisticasCotenidos.ascx" tagname="DisplayEstadisticasCotenidos" tagprefix="uc1" %>
...
<asp:Content ID="contentCentral" ContentPlaceHolderID="ContentPanelCentral" Runat="Server">
                     ...
                     <div class="panel">
                            <div class="panel-heading">
                                   ...
                                   <div ID="panelEdicion" class="panel-control" runat="server" Visible="false" style="text-align:right">
					                 <asp:HyperLink ID="lnkEdicionContenido" runat="server" CssClass="btn btn-primary btn-sm">Editar actividad</asp:HyperLink>
				                 </div>
    ...
    <!--
                     ...
                     <uc1:DisplayEstadisticasCotenidos ID="DisplayEstadisticasCotenidos1" runat="server" />
                     ...
                     <div class="panel">
                        ...
                        <div class="panel-body" style="font-size:11px;">
                          ...
                          <div runat="server" id="panelDesplegarFechas" visible="false">
                            <asp:Label ID="Label10" runat="server" Text="Abierta desde:" Font-Bold="true"></asp:Label>
                            <div style="height:3px"></div>
						<asp:Label ID="lblFechaEntrega" runat="server" Text=""></asp:Label>
                            <div style="height:6px"></div>
                        <asp:Label ID="Label11" runat="server" Text="Puede ser enviada hasta:" Font-Bold="true"></asp:Label>
                            <div style="height:3px"></div>
