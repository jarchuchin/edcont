<%@ Page Title="" Language="VB" MasterPageFile="~/MPDiamante03.master" AutoEventWireup="false" CodeFile="SalaVirtualNA.aspx.vb" Inherits="Sec_SalonVirtual_SalaVirtualNA" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPanelTitulo" runat="server">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow"><asp:Label ID="lblNombreTitulo" runat="server"  Text="Sala virtual no activa" ></asp:Label> </h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="ContentPanelBreadcrumb">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><asp:Label ID="lblCursoBread" runat="server"  Text="Sala virtual" ></asp:Label></li>
    </ol>
        ...
        <div class="col-xs-9">
            ...
            <div class="panel">
                <div class="panel-heading">
                        <h3 class="panel-title"><asp:Label ID="lblCalendario" runat="server" Text="Sala Virtual"></asp:Label> </h3>
                </div>
                <div class="panel-body">

    
              <asp:Label ID="label1" runat="server" Text="Sala virtual no activa. El maestro debe solicitar el acceso al sistema de conferenciar virtual a la Administración" ></asp:Label>
