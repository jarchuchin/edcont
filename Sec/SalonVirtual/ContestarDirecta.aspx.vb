...
Partial Class Sec_SalonVirtual_ContestarDirecta
    ...
    Sub colocarDatos()
        ...
        If Request("idSalonVirtual") <> "" Then
			...
			If myER.existe Then
				txtid.Text = myER.id
				txtRespuesta.Text = myER.respuesta
			End If
		End If
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        If CInt(Session("gUserProfileSession").idUserProfile) = 0 Then
            Dim cadena As String = "login.aspx?ReturnUrl=" & System.Configuration.ConfigurationManager.AppSettings("carpetaVirtual") & "sec/examenes/ContestarDirecta.aspx?idSalonVirtual" & Request("idSalonVirtual") & "&idCI=" & Request("idCI") & "&idP=" & Request("idP")
    ...
    Sub editar()
        ...
        myer.Respuesta = txtRespuesta.Text
        myer.fecha = Date.Now
        myer.Update()
    End Sub
