<%@ Page Language="VB" MasterPageFile="~/MPDiamante03.master" AutoEventWireup="false" CodeFile="ContestarDirecta.aspx.vb" Inherits="Sec_SalonVirtual_ContestarDirecta" title="Pregunta directa" ValidateRequest="false" %>
...
<%--	<div><asp:Label ID="lblpregunta" runat="server" Font-Bold="False">Enunciado</asp:Label></div>--%>
	...
	<div>
		<asp:Label ID="lblrespuesta" runat="server" Font-Bold="False" Text="Escribe tu respuesta"></asp:Label>&nbsp;
		<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRespuesta" Display="Dynamic" ForeColor="Red">*</asp:RequiredFieldValidator>
	</div>

	<div>
		<asp:TextBox ID="txtRespuesta" runat="server" Columns="70" Rows="10" TextMode="MultiLine"></asp:TextBox>
	</div>
