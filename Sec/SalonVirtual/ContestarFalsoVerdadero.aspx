<%@ Page Language="VB" MasterPageFile="~/MPDiamante03.master" AutoEventWireup="false" CodeFile="ContestarFalsoVerdadero.aspx.vb" Inherits="Sec_SalonVirtual_ContestarFalsoVerdadero" title="Falso o verdadero" %>
...
<asp:Content ID="contentCentral" ContentPlaceHolderID="ContentPanelCentral" Runat="Server">
	...
	<asp:Panel ID="panelEdicion" runat="server" Visible="false">
     ...
     <div class="panel">
		...
		<asp:ValidationSummary ID="ValidationSummary1" runat="server" displaymode="List" headertext="Los campos marcados con * son requeridos"  ForeColor="Red"/>
...
<%--	<div><asp:Label ID="lblpregunta" runat="server" Font-Bold="False">Enunciado</asp:Label></div>--%>
	...
	<div>
		<asp:Label ID="lblrespuesta" runat="server" Font-Bold="False" Text="Selecciona tu respuesta"></asp:Label>&nbsp;
		<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="rdbFV2" Display="Dynamic" ForeColor="Red">*</asp:RequiredFieldValidator>
	</div>
	<div style="padding-top:15px; padding-bottom:15px;">
		<asp:RadioButtonList ID="rdbFV2" runat="server" RepeatDirection="Horizontal"  Font-Bold="True">
			<asp:ListItem Value="V" Text="Verdadero"></asp:ListItem>
			<asp:ListItem Value="F" Text="Falso"></asp:ListItem>
		</asp:RadioButtonList>
	</div>
	<div style="margin-bottom:20px;">
		<asp:Label ID="valor" runat="server" Font-Bold="true"></asp:Label>&nbsp;
		<asp:Label ID="lblValor" runat="server" Font-Bold="true" Text="Puntos" ></asp:Label>
	</div>
