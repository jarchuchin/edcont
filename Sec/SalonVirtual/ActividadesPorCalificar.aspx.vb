...
Partial Class Sec_SalonVirtual_ActividadesPorCalificar
    ...
    Public Function getRespuesta(ByVal usuario As Integer) As String
        ...
        Select Case mya.tipodeActividad
            Case Contenidos.ETipodeActividad.Actividad
                cadena = ""
                If myr.existe Then
                    cadena = "~/Sec/SalonVirtual/CalificarRespuestaGrupal.aspx?idSalonVirtual=" & myasv.idSalonVirtual & "&idR=" & myr.id & "&pag=actividadesporcalificar" & "&idCI=" & Request("idCI")
                End If
    ...
    Public Function getRespuesta2(ByVal usuario As Integer) As String
        Dim myr As Contenidos.Respuesta = New Contenidos.Respuesta(0, myasv.idActividad, tipoObjeto.Actividad.ToString, myasv.idSalonVirtual, usuario)
        Dim cadena As String = ""
        ...
        Select Case mya.tipodeActividad
            Case Contenidos.ETipodeActividad.Actividad
                cadena = ""
                If myr.existe Then
                    cadena = "~/Sec/SalonVirtual/CalificacionesActividad.aspx?idSalonVirtual=" & myasv.idSalonVirtual & "&idR=" & myr.id
                End If
