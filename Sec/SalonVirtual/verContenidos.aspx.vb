...
Partial Class Sec_SalonVirtual_VerContenidos
    ...
    Public Function populateNodes(ByVal dt As System.Data.DataTable, ByVal nodes As TreeNodeCollection) As Integer
        ...
        For Each dr As Data.DataRow In dt.Rows
			...
			nodocarpeta.NavigateUrl = "verCarpeta.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idClasificacion=" & dr("idClasificacion")
		...
		Do While drHijos.Read
			...
			Select Case CType(drHijos("procedencia"), String)
				Case tipoObjeto.Contenido.ToString
					...
					Select Case mycont.idTipoContenido
						Case Contenidos.TipoContenido.Archivo
							url = "verArchivo.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & drHijos("idClasificacionItem")
						Case Contenidos.TipoContenido.Flash
							url = "verFlash.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & drHijos("idClasificacionItem")
						Case Contenidos.TipoContenido.Imagen
							url = "verImagen.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & drHijos("idClasificacionItem")
						Case Contenidos.TipoContenido.Texto
							url = "verTexto.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & drHijos("idClasificacionItem")
				...
				Case tipoObjeto.Actividad.ToString
					...
					Select Case myact.tipodeActividad
						Case Contenidos.ETipodeActividad.Actividad
							url = "verActividad.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & drHijos("idClasificacionItem")
						Case Contenidos.ETipodeActividad.Examen
							url = "verExamen.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & drHijos("idClasificacionItem")
					End Select
					Select Case myact.tipodeActividad
						Case Contenidos.ETipodeActividad.Actividad
				...
				Case tipoObjeto.Foro.ToString
					...
					url = "verForo.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & drHijos("idClasificacionItem")
