<%@ Page Language="VB" MasterPageFile="~/MPDiamante03.master" AutoEventWireup="false" CodeFile="PreguntasNueva.aspx.vb" Inherits="Sec_SalonVirtual_PreguntasNueva" title="Editar pregunta" ValidateRequest="false" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPanelTitulo" runat="server">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow"><asp:Label ID="lblNombreTitulo" runat="server"  Text="Hacer preguntas" ></asp:Label></h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
        ...
        <div class="col-xs-9">
            ...
            <div class="panel">
                <div class="panel-heading">
                        <h3 class="panel-title"><asp:Label ID="Label1" runat="server" Text="Escribe tu duda o pregunta"></asp:Label></h3>
                </div>
            ...
            <asp:TextBox ID="txtpregunta" TextMode="MultiLine" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>


                      <script>
                         $(document).ready(function () {
                             $("#txtpregunta").cleditor({
                                 height: 350,
