...
Partial Class Sec_Workbook_Flash
    ...
    Private Sub btnBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBorrar.Click
        ...
        myCI.Remove()
        Response.Redirect("Explorar.aspx?idRoot=" & Request("idRoot") & "&idClasificacion=" & Request("idClasificacion"))
            ...
            If tieneEspacio() Then
                ...
                If txtid.Text <> "" Then
                    If File1.PostedFile.FileName <> "" Then
                        ...
                        Else
                            myci = editar()
                            Dim cadenaredirec As String = "Explorar.aspx?idRoot=" & Request("idRoot") & "&idCI=" & myci.id & "&Proc=Flash&idClasificacion=" & myci.idClasificacion
                            If Request("idSalonVirtual") <> "" Then
                                Response.Redirect("../SalonVirtual/verFlash.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & myci.id)
                            Else
