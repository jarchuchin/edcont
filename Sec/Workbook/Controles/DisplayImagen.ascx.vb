...
Partial Class Sec_Workbook_Controles_DisplayImagen
    ...
    Sub editar()
        ...
        Dim cadenaredirec As String = "~/sec/workbook/AddAnexos.aspx?idRoot=" & Request("idRoot") & "&idCI=" & myCI.id & "&Proc=Imagen&idClasificacion=" & myCI.idClasificacion & "&regreso=" & Request("regreso") & "&grabado=1"
