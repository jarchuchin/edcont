...
Partial Class Sec_Workbook_Controles_showAdjuntosEdicion2
    ...
    Sub colocarDatos()
        ...
        gvAdjuntos.DataSource = myca.GetDRNoLigas(myCI.idProc, myCI.procedencia.ToString)
        gvAdjuntos.DataBind()
