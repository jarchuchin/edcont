<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DisplayImagen.ascx.vb" Inherits="Sec_Workbook_Controles_DisplayImagen" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
      <h2 class="text-center"><asp:Label ID="Label1" runat="server" Text="Editar imagen" meta:resourcekey="Label1Resource1"  ></asp:Label> </h2>
...
<div class="alert alert-danger" id="lblNoarchivo" runat="server" visible="false">
  <span class="glyphicon glyphicon-saved"></span><strong>&nbsp; <asp:Label ID="Label3" runat="server" Text="Error!" meta:resourcekey="Label3Resource1"></asp:Label>&nbsp;&nbsp; </strong><asp:Label ID="lblNoarchivo12" runat="server"  text="Se esperaba una imagen. Selecciona la imagen e intenta nuevamente. Si es un archivo utiliza la forma para subir archivos" meta:resourcekey="lblNoarchivo12Resource1"></asp:Label>
</div>
...
<div class="form-group">
    <label class="col-sm-3 control-label">
        <asp:Label ID="lbltituloContenido" runat="server" Text="Título de imagen" meta:resourcekey="lbltituloContenidoResource1" ></asp:Label>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        <asp:Image ID="Imagen" runat="server" meta:resourcekey="ImagenResource1" Visible="False" Width="200px" />
        <br />
