<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DisplayArchivo.ascx.vb" Inherits="Sec_Workbook_Controles_DisplayArchivo" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

  
      <h2 class="text-center"><asp:Label ID="Label1" runat="server" Text="Editar archivo" meta:resourcekey="Label1Resource1"  ></asp:Label> </h2>
...
<div class="alert alert-danger" id="lblNoarchivo" runat="server" visible="false">
  <span class="glyphicon glyphicon-saved"></span><strong>&nbsp; <asp:Label ID="Label3" runat="server" Text="Error!" meta:resourcekey="Label3Resource1"></asp:Label>&nbsp;&nbsp; </strong><asp:Label ID="lblNoarchivo12" runat="server"  text="Se esperaba una archivo. Selecciona la archivo e intenta nuevamente. Si es una imagen utiliza la opciones para subir imágenes" meta:resourcekey="lblNoarchivo12Resource1"></asp:Label>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
         <asp:DropDownList ID="drpUbicacion" runat="server"  CssClass="form-control" meta:resourcekey="drpUbicacionResource1" Height="30px" > </asp:DropDownList>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        <asp:Label ID="lblNombreOriginal" Font-Bold="true" runat="server" meta:resourcekey="lblNombreOriginalResource1" Visible="False"></asp:Label>
        <asp:Label ID="lblEspacio" runat="server" Font-Bold="true" meta:resourcekey="lblEspacioResource1" Visible="False"></asp:Label>
        <br />
        <asp:HyperLink ID="lnkDownload" CssClass="btn-link" runat="server" meta:resourcekey="lnkDownloadResource1" Text="Descargar" Visible="False"></asp:HyperLink>
        ...
        <asp:Button ID="btnGrabar" runat="server" CssClass="btn btn-success" Text="Grabar" meta:resourcekey="btnGrabarResource1" />&nbsp;
         ...
         &nbsp;<asp:Button ID="btnregresar" runat="server" CssClass="btn btn-default" Text="Cancelar" CausesValidation="False" meta:resourcekey="btnregresarResource1"   />
          ...
          <div style="height:40px;"></div>
				...
				<asp:HyperLink ID="lnkVistaPrevia" runat="server" Enabled="False" CssClass="btn btn-primary" Text="Vista previa" visible="false" meta:resourcekey="lnkVistaPreviaResource1"></asp:HyperLink>
