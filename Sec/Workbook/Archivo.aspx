<%@ Page Language="VB" MasterPageFile="~/MPUsmart01.master" AutoEventWireup="false" CodeFile="Archivo.aspx.vb" Inherits="Sec_Workbook_Archivo" title="Archivos" ValidateRequest="False" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanelCentral" Runat="Server">
     ...
     <div id="Caja">
          <asp:Label ID="Label1" runat="server" Text="Agregar o editar archivos" CssClass="TituloCaja"  ></asp:Label> 
            <div id="CajaInterna">
...
<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
		<TR>
			<TD>
			      ...
			      <asp:Label ID="lblNoarchivo" runat="server" ForeColor="Red" Visible="False" 
                                        CssClass="Mediana">Se esperaba una imagen. Selecciona la imagen e intenta nuevamente. Si es un archivo utiliza la forma para subir archivos</asp:Label>
	...
	<TABLE id="Table5" cellSpacing="1" cellPadding="1" width="100%" border="0">
		...
		<tr>
			<td class="style1" style="width: 156px">
				<asp:Label ID="lbltituloContenido" runat="server" CssClass="Mediana">Título de archivo</asp:Label>
				<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                       ControlToValidate="txtTitulo" Display="Dynamic">*</asp:RequiredFieldValidator></td>
			<td>
				<asp:TextBox ID="txtTitulo" runat="server" Width="350px" MaxLength="200"></asp:TextBox>
				<asp:TextBox ID="txtid" runat="server" Visible="False"></asp:TextBox></td>
		</tr>
		<TR>
			<TD vAlign="top" class="style1" style="width: 156px">
			...
			<TD>
				<asp:textbox id="txtTextoCorto" runat="server" Columns="55" Rows="7" 
                    TextMode="MultiLine" Height="60px" Width="356px"></asp:textbox></TD>
		</TR>
		<tr>
		...
		<TR>
			<TD class="style1" style="width: 156px">
				<asp:label id="lblfile1" runat="server" CssClass="Mediana">Selecciona el archivo</asp:label></TD>
			<TD><INPUT id="File1" type="file" name="File1" runat="server"></TD>
		</TR>
		<TR>
			<TD class="style1" style="width: 156px"></TD>
			<TD>
		...
		<TR>
			<TD class="style1" style="width: 156px"></TD>
			<TD>
				<asp:HyperLink id="lnkDownload" runat="server" Visible="False" CssClass="Mediana">Descargar</asp:HyperLink></TD>
		</TR>
		<TR>
			<TD class="style1" style="width: 156px"></TD>
			<TD>
