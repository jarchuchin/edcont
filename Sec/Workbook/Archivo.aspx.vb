...
Partial Class Sec_Workbook_Archivo
    ...
    Sub editar()
        ...
        Dim cadenaredirec As String = "Archivo.aspx?idRoot=" & Request("idRoot") & "&idCI=" & myCI.id & "&Proc=Archivo&idClasificacion=" & myCI.idClasificacion
        If Request("idSalonVirtual") <> "" Then
            Response.Redirect("../SalonVirtual/verArchivo.aspx?idSalonVirtual=" & Request("idSalonVirtual") & "&idCI=" & myCI.id)
        Else
